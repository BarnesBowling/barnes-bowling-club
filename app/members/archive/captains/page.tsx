        ...
        <div style={{ background: 'var(--green-deep)', padding: '1rem 2rem 4rem', color: 'var(--cream)' }}>
          <div className="section-inner">
            ...
            <h1 className="section-h2" style={{ color: 'var(--cream)', fontSize: 'clamp(1.75rem,4vw,2.75rem)' }}>
              Past <em style={{ color: 'var(--gold)', fontStyle: 'italic' }}>Captains</em>
            </h1>
            <p className="section-lead" style={{ color: 'rgba(245,240,232,.65)' }}>
              <em style={{ color: 'var(--gold)', fontStyle: 'italic' }}>Captains</em> of Barnes Bowling Club, 1977 to present.
            </p>
          </div>
        </div>
